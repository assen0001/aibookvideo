...
Source Server         : rm-bp1x1sc76612d82yteo-阿里云数据库(9.11)
Source Server Version : 50744
Source Host           : rm-bp1x1sc76612d82yteo.mysql.rds.aliyuncs.com:3306
...
CREATE TABLE `ai_booklist` (
  ...
  `book_note` varchar(999) DEFAULT NULL COMMENT '书籍简介',
  `book_supplement_prompt` varchar(255) DEFAULT NULL COMMENT '补充性提示词',
  `book_content` varchar(9999) DEFAULT NULL COMMENT 'AI生成方案',
...
CREATE TABLE `ai_imageslist` (
  ...
  `paragraph_initial` varchar(512) DEFAULT NULL COMMENT '段落',
  `paragraph_prompt_cn` varchar(512) DEFAULT NULL COMMENT '段落提示词（中文）',
  `paragraph_prompt_en` varchar(512) DEFAULT NULL COMMENT '段落提示词（英文）',
