...
@images_bp.route('/get_images/<int:book_id>')
...
@images_bp.route('/update_image_status', methods=['POST'])
...
@images_bp.route('/update_paragraph', methods=['POST'])
...
@images_bp.route('/delete_image', methods=['POST'])
def delete_image():
    data = request.json
    connection = get_db_connection()
    try:
...
@images_bp.route('/get_images_by_id', methods=['POST'])
...
@images_bp.route('/get_video_url', methods=['POST'])
def get_video_url():
